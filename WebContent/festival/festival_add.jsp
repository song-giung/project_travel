...
<body>
	...
	<h1 style="text-align: center;">축제 상세정보 등록</h1>
	<form name="gForm" action="./festival_add.fs" enctype="multipart/form-data" method="post">
		...
		<table id="first_table">
			<tr>
				...
				<td colspan="3" ><input type="text" name="name" id="name"
					placeholder="축제 이름을 입력하세요." class="brsilver"></td>
			</tr>
			<tr>
				<th>지역</th>
			...
			<tr>
				...
				<input type="text" class="search_date" size="14" id="startdate" value="" name="startdate"> -
               	<input type="text" class="search_date" size="14" id="enddate" value="" name="enddate">
				 </td>
			</tr>
			<tr>
				<th>세부 내용</th>
				<td colspan="3" class="brsilver"><textarea name="textarea" rows="10" cols="100" placeholder="Write something here"></textarea></td>
			</tr>
			<tr>
				<th>이미지 </th>
				<td class="brsilver">
