...
<body>
	...
	<table id="first_table">
		<tr>
			<th>축제  이름</th>
			<td colspan=3 class="brsilver">${festival.festival_name }</td>
		</tr>
		<tr>
			<th>지역</th>
			<td class="brsilver">${festival.location}</td>
			<th>주소</th>
			<td class="brsilver">${festival.festival_address }</td>
		</tr>
		<tr>
			<th>축제 시작일</th>
			<td class="brsilver">
			...
			<th>축제 마감일</th>
			<td class="brsilver">${festival.endday }</td>
		</tr>
		<tr>
			<th>내용</th>
