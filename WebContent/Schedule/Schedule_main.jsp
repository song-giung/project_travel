			...
			<fieldset>
				...
				<div id="bus_info">
					<table class='main_table'>
						...
						<tbody>
						<c:forEach var='bus' items='${ubib }'>
							<tr>
								<td>${bus.bus_start_location }</td>
								<td>${bus.bus_end_location }</td>
								<td>${bus.bus_time_departure }</td>
								<td>${bus.bus_time_arrival }</td>
								<td>${bus.bus_time_cost }</td>
							</tr>
						</c:forEach>
						</tbody>
					</table>
