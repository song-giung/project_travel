...
<script src='./Schedule/calendar/lib/jquery.min.js'></script>
...
$(function(){
		...
		$(document).on('click','.changePage',function(){
			...
			if(page=='다음')
		 	...
		 	$.ajax({
				...
				data:{"page":page,"state":"ajax","Schedule_choice":"all"},
				success: function(data){
	...
	$(document).on('click','.changePageDT',function(){
			...
			if(pageDT=='다음')
		 	...
		 	$.ajax({
				url: "./MyScheduleManage.s",
				data:{"pageDT":pageDT,"stateDT":"ajax","Schedule_choice":"all"},
				success: function(data){
...
<div id='content'>
	...
	<div id="schedule_Manage_view" class="box">
			<fieldset>
				...
				<div>
					<form id="choise_all_select"method="post" action="./MyScheduleManage.s"  >
